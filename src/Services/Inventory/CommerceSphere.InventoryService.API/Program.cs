...
builder.Services.AddValidatorsFromAssemblyContaining<ReserveInventoryRequestValidator>();
...
{
    c.SwaggerDoc("v1", new OpenApiInfo { Title = "CommerceSphere Inventory API", Version = "v1" });
...
await app.Services.MigrateInventoryDbAsync();
